...
Clone this repository to your local machine using VS Code.

Link the repository to your Databricks Workspace via Git integration.

Ensure you are running a Databricks cluster with Unity Catalog enabled.

Run the scripts sequentially (01 through 04).